      ...
      ws.onopen = async () => {
        ...
        if (rectRes && rectRes.result && rectRes.result.value) {
          ...
          if (shotFood && shotFood.data) {
            ...
            fs.writeFileSync('C:/Users/admin/.gemini/antigravity/brain/23f01a5d-861a-4e45-94bc-9090a5b438cf/food_section_real.png', buf);
            console.log("Saved food_section_real.png (" + (buf.length / 1024).toFixed(1) + " KB)");
          }
        }
