    ...
    res.on('end', async () => {
      ...
      ws.onopen = async () => {
        ...
        if (shot && shot.data) {
          ...
          fs.writeFileSync('C:/Users/admin/.gemini/antigravity/brain/23f01a5d-861a-4e45-94bc-9090a5b438cf/mockup_viewport_live.png', buf);
          console.log("Saved mockup_viewport_live.png (" + (buf.length / 1024).toFixed(1) + " KB)");
        }
